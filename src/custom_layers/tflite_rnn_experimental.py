...
experimental RNN layers copied from
https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/experimental/examples/lstm/rnn_cell.py
...
class TfLiteRNNCell(rnn_cell_impl.LayerRNNCell):
  ...
  def __init__(self,
    ...
    self._tflite_wrapper = tf.contrib.lite.OpHint("UnidirectionalSequenceRnn")
...
class TFLiteLSTMCell(rnn_cell_impl.LayerRNNCell):
  ...
  def __init__(self,
    ...
    self._tflite_wrapper = tf.contrib.lite.OpHint("UnidirectionalSequenceLstm")
